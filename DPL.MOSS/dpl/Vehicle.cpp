...
// 0x5AE587
void CVehicle::GetPosition(Vector4* returnStorage)
{
	// old method
	/*
...
void CVehicle::SetPosition(Vector4* pos)
{
	...
	*/
	...
	// new method
	PHobject* obj = GetPhysicsObject();
	
	//phObjectPositionAndOrientationSet(obj, &obj->m_qOrientation, pos);
	phObjectPositionSet(obj, pos);
}
...
void CVehicle::SetVelocity(Vector4 pos)
{
	...
	*/
	...
	// new method
	PHobject* obj = GetPhysicsObject();
	phObjectVelocitySet((OBobject*)obj, &pos);
}
...
// The orientation quaternion of the vehicle that defines the rotation
...
void CVehicle::SetDirection(Vector4* quat)
{
	// old method
	/*
	Vector4* ptrVec = (Vector4*)(GetMatrixBaseAddress(this) + MAT_DIR_OFF);
	...
	*/
	...
	//phObjectPositionAndOrientationSet(GetPhysicsObject(), quat, &position);
	phObjectOrientationSet(GetPhysicsObject(), quat);
}
